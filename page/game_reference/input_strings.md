...
| INPUT_CAMERA_SWITCH_LEFT | ![DPAD LEFT](https://raw.githubusercontent.com/Red-Mods/RDRMP-Docs/main/assets/xbox_button_icons/8KEeiDT.png) | ![X](https://raw.githubusercontent.com/Red-Mods/RDRMP-Docs/main/assets/keyboard_button_icons/lWkYN97.png) |
...
| INPUT_GENERIC_LOOK_AT | ![B](https://raw.githubusercontent.com/Red-Mods/RDRMP-Docs/main/assets/xbox_button_icons/9qlEa0H.png) | ![V](https://raw.githubusercontent.com/Red-Mods/RDRMP-Docs/main/assets/keyboard_button_icons/TxV371v.png) |
...
| INPUT_RADIAL_MENU_SHOW_HIDE | ![RB](https://raw.githubusercontent.com/Red-Mods/RDRMP-Docs/main/assets/xbox_button_icons/N6tGiDZ.png) | ![TAB](https://raw.githubusercontent.com/Red-Mods/RDRMP-Docs/main/assets/keyboard_button_icons/Wm7nhET.png) |
...
| INPUT_HORSESHOES_AIM | ![LTRIGGER](https://raw.githubusercontent.com/Red-Mods/RDRMP-Docs/main/assets/xbox_button_icons/B32aDhG.png) | ![LCTRL](https://raw.githubusercontent.com/Red-Mods/RDRMP-Docs/main/assets/keyboard_button_icons/PPkge6g.png) |
...
local inputsList =
{
    ["INPUT_UI_ACCEPT"] = "@UI.ACCEPT", -- "A" / "ENTER"
    ["INPUT_UI_CANCEL"] = "@UI.CANCEL", -- "B" / "ESC"
    ["INPUT_UI_CANCEL_MINIGAME"] = "@UI.CANCELMINIGAME", -- "B" / "BACKSPACE"
    ["INPUT_UI_ACTION_1"] = "@UI.ACTION_1", -- "Y" / "F"
    ["INPUT_UI_ACTION_2"] = "@UI.ACTION_2", -- "X" / "R"
    ["INPUT_UI_ACTION_3"] = "@UI.ACTION_3", -- "LSTICK" / "1"
    ["INPUT_UI_ACTION_4"] = "@UI.ACTION_4", -- "RSTICK" / "2"
    ["INPUT_UI_PREVIOUS_TAB"] = "@UI.PREVIOUS_TAB", -- "LB" / "Q"
    ["INPUT_UI_NEXT_TAB"] = "@UI.NEXT_TAB", -- "RB" / "E"
    ["INPUT_UI_ZOOM_OUT"] = "@UI.ZOOM_OUT", -- "LTRIGGER" / "MOUSE WHEEL DOWN"
    ["INPUT_UI_ZOOM_IN"] = "@UI.ZOOM_IN", -- "RTRIGGER" / "MOUSE WHEEL UP"
    ["INPUT_UI_ZOOM_CINEMA"] = "@UI.ZOOM_CINEMA", -- "LTRIGGER" / "Z"
    ["INPUT_UI_NAVIGATE_UP"] = "@UI.NAVIGATE_UP", -- "LSTICK UP" / "ARROW KEY UP"
    ["INPUT_UI_NAVIGATE_DOWN"] = "@UI.NAVIGATE_DOWN", -- "LSTICK DOWN" / "ARROW KEY DOWN"
    ["INPUT_UI_NAVIGATE_LEFT"] = "@UI.NAVIGATE_LEFT", -- "LSTICK LEFT" / "ARROW KEY LEFT"
    ["INPUT_UI_NAVIGATE_RIGHT"] = "@UI.NAVIGATE_RIGHT", -- "LSTICK RIGHT" / "ARROW KEY RIGHT"
    ["INPUT_UI_VKB_CANCEL"] = "@UI.VKB_CANCEL", -- "B" / "ESC"
    ["INPUT_UI_MOUSE_CLICK"] = "@UI.MOUSE_CLICK", -- "BLANK" / "LEFT MOUSE CLICK"
    ["INPUT_CAMERA_MOVE_X"] = "@CAMERA.MOVE_X", -- "RSTICK X" / "NULL" GET_ANALOGUE_ACTION Only
    ["INPUT_CAMERA_MOVE_Y"] = "@CAMERA.MOVE_Y", -- "RSTICK Y" / "NULL" GET_ANALOGUE_ACTION Only
    ["INPUT_CAMERA_UP"] = "@CAMERA.UP", -- "RSTICK UP" / "MOUSE UP"
    ["INPUT_CAMERA_DOWN"] = "@CAMERA.DOWN", -- "RSTICK DOWN" / "MOUSE DOWN"
    ["INPUT_CAMERA_LEFT"] = "@CAMERA.LEFT", -- "RSTICK LEFT" / "MOUSE LEFT"
    ["INPUT_CAMERA_RIGHT"] = "@CAMERA.RIGHT", -- "RSTICK RIGHT" / "MOUSE RIGHT"
    ["INPUT_CAMERA_LOOK_BACK"] = "@CAMERA.LOOK_BACK", -- "RSTICK" / "C"
    ["INPUT_CAMERA_SWITCH_LEFT"] = "@CAMERA.SWITCH_LEFT", -- "DPAD LEFT" / "X"
    ["INPUT_CAMERA_SWITCH_RIGHT"] = "@CAMERA.SWITCH_RIGHT", -- "DPAD RIGHT" / "BLANK"
    ["INPUT_FOOT_INTERACT"] = "@FOOT.INTERACT", -- "B" / "R"
    ["INPUT_FOOT_COVER"] = "@FOOT.COVER", -- "RB" / "Q"
    ["INPUT_FOOT_CROUCH"] = "@FOOT.CROUCH", -- "LSTICK" / "LCTRL"
    ["INPUT_FOOT_JUMP"] = "@FOOT.JUMP", -- "X" / "SPACEBAR"
    ["INPUT_FOOT_SPRINT"] = "@FOOT.SPRINT", -- "A" / "LSHIFT"
    ["INPUT_FOOT_MELEE_BLOCK"] = "@FOOT.MELEE_BLOCK", -- "RB" / "R"
    ["INPUT_FOOT_MELEE_SPECIAL"] = "@FOOT.MELEE_SPECIAL", -- "Y" / "F"
    ["INPUT_GENERIC_MOVE_X"] = "@GENERIC.MOVE_X", -- "LSTICK X" / "WS" GET_ANALOGUE_ACTION Only
    ["INPUT_GENERIC_MOVE_Y"] = "@GENERIC.MOVE_Y", -- "LSTICK Y" / "AD" GET_ANALOGUE_ACTION Only
    ["INPUT_GENERIC_MOVE_FORWARD"] = "@GENERIC.MOVE_FORWARD", -- "LSTICK UP" / "W"
    ["INPUT_GENERIC_MOVE_BACK"] = "@GENERIC.MOVE_BACK", -- "LSTICK DOWN" / "S"
    ["INPUT_GENERIC_MOVE_LEFT"] = "@GENERIC.MOVE_LEFT", -- "LSTICK LEFT" / "A"
    ["INPUT_GENERIC_MOVE_RIGHT"] = "@GENERIC.MOVE_RIGHT", -- "LSTICK RIGHT" / "D"
    ["INPUT_GENERIC_INVENTORY"] = "@GENERIC.INVENTORY", -- "BACK BUTTON" / "B"
    ["INPUT_GENERIC_BRAKE"] = "@GENERIC.BRAKE", -- "RB" / "LCTRL"
    ["INPUT_GENERIC_USE"] = "@GENERIC.USE", -- "Y" / "E"
    ["INPUT_GENERIC_USE2"] = "@GENERIC.USE2", -- "X" / "F"
    ["INPUT_GENERIC_TARGET"] = "@GENERIC.TARGET", -- "LTRIGGER" / "RIGHT MOUSE BUTTON"
    ["INPUT_GENERIC_WHISTLE"] = "@GENERIC.WHISTLE", -- "DPAD UP" / "H"
    ["INPUT_GENERIC_ZOOM_RADAR"] = "@GENERIC.ZOOM_RADAR", -- "DPAD DOWN" / "T"
    ["INPUT_GENERIC_DEADEYE"] = "@GENERIC.DEADEYE", -- "RSTICK" / "MOUSE WHEEL CLICK"
    ["INPUT_GENERIC_DEADEYE_PAINT"] = "@GENERIC.DEADEYE_PAINT", -- "RB" / "Q"
    ["INPUT_GENERIC_FIRE"] = "@GENERIC.FIRE", -- "RTRIGGER" / "LEFT MOUSE BUTTON"
    ["INPUT_GENERIC_RELOAD"] = "@GENERIC.RELOAD", -- "B" / "R"
    ["INPUT_GENERIC_LOOK_AT"] = "@GENERIC.LOOK_AT", -- "B" / "V"
    ["INPUT_HORSE_SPUR"] = "@HORSE.SPUR", -- "A" / "LSHIFT"
    ["INPUT_HORSE_JUMP"] = "@HORSE.JUMP", -- "X" / "SPACEBAR"
    ["INPUT_PRESS_START_OPEN_SETTINGS"] = "@PRESS_START.OPEN_SETTINGS", -- "LSTICK" / "Z"
    ["INPUT_PRESS_START_PRESS_START"] = "@PRESS_START.PRESS_START", -- "A" / "ENTER"
    ["INPUT_PAUSE_PAUSE"] = "@PAUSE.PAUSE", -- "START" / "ESC"
    ["INPUT_DETONATOR_DETONATE"] = "@DETONATOR.DETONATE", -- "RTRIGGER" / "SPACEBAR"
    ["INPUT_DETONATOR_LEAVE"] = "@DETONATOR.LEAVE", -- "Y" / "E"
    ["INPUT_DETONATOR_LOOK_AT_TARGET"] = "@DETONATOR.LOOK_AT_TARGET", -- "B" / "V"
    ["INPUT_DETONATOR_SELECT_LEFT"] = "@DETONATOR.SELECT_LEFT", -- "LSTICK LEFT" / "A"
    ["INPUT_DETONATOR_SELECT_RIGHT"] = "@DETONATOR.SELECT_RIGHT", -- "LSTICK RIGHT" / "D"
    ["INPUT_KEYBINDINGS_DELETE"] = "@KEYBINDINGS.DELETE", -- "RSTICK" / "X"
    ["INPUT_KEYBINDINGS_RESET"] = "@KEYBINDINGS.RESET", -- "Y" / "LSHIFT"
    ["INPUT_KEYBINDINGS_RESTORE"] = "@KEYBINDINGS.RESTORE", -- "X" / "SPACEBAR"
    ["INPUT_MAP_OPEN"] = "@MAP.OPEN", -- "START" / "M"
    ["INPUT_MAP_SCROLL_UP"] = "@MAP.SCROLL_UP", -- "LSTICK UP" / "MOUSE UP"
    ["INPUT_MAP_SCROLL_DOWN"] = "@MAP.SCROLL_DOWN", -- "LSTICK DOWN" / "MOUSE DOWN"
    ["INPUT_MAP_SCROLL_LEFT"] = "@MAP.SCROLL_LEFT", -- "LSTICK LEFT" / "MOUSE LEFT"
    ["INPUT_MAP_SCROLL_RIGHT"] = "@MAP.SCROLL_RIGHT", -- "LSTICK RIGHT" / "MOUSE RIGHT"
    ["INPUT_MAP_SCROLL_LEGEND_UP"] = "@MAP.SCROLL_LEGEND_UP", -- "RSTICK UP" / "MOUSE WHEEL UP"
    ["INPUT_MAP_SCROLL_LEGEND_DOWN"] = "@MAP.SCROLL_LEGEND_DOWN", -- "RSTICK DOWN" / "MOUSE WHEEL DOWN"
    ["INPUT_MAP_PLACE_WAYPOINT"] = "@MAP.PLACE_WAYPOINT", -- "A" / "ENTER"
    ["INPUT_RADIAL_MENU_LEFT"] = "@RADIAL_MENU.LEFT", -- "DPAD LEFT" / "BLANK"
    ["INPUT_RADIAL_MENU_RIGHT"] = "@RADIAL_MENU.RIGHT", -- "DPAD RIGHT" / "BLANK"
    ["INPUT_RADIAL_MENU_SHOW_HIDE"] = "@RADIAL_MENU.SHOW_HIDE", -- "RB" / "TAB"
    ["INPUT_SHOP_INCREASE_QUANTITY"] = "@SHOP.INCREASE_QUANTITY", -- "RSTICK UP" / "I"
    ["INPUT_SHOP_DECREASE_QUANTITY"] = "@SHOP.DECREASE_QUANTITY", -- "RSTICK DOWN" / "K"
    ["INPUT_WAGON_SWITCH_SEAT"] = "@WAGON.SWITCH_SEAT", -- "X" / "R"
    ["INPUT_ARM_WRESTLING_SKIP_HELP"] = "@ARM_WRESTLING.SKIP_HELP", -- "RB" / "Q"
    ["INPUT_ARM_WRESTLING_CAMERA_TOGGLE"] = "@ARM_WRESTLING.CAMERA_TOGGLE", -- "Y" / "C"
    ["INPUT_ARM_WRESTLING_WRESTLE"] = "@ARM_WRESTLING.WRESTLE", -- "A" / "LEFT MOUSE CLICK"
    ["INPUT_ARM_WRESTLING_SLAM"] = "@ARM_WRESTLING.SLAM", -- "X" / "S"
    ["INPUT_BLACKJACK_SKIP_DEAL"] = "@BLACKJACK.SKIP_DEAL", -- "LB" / "RCTRL"
    ["INPUT_BLACKJACK_ACCEPT_INSURANCE"] = "@BLACKJACK.ACCEPT_INSURANCE", -- "X" / "R"
    ["INPUT_BLACKJACK_REJECT_INSURANCE"] = "@BLACKJACK.REJECT_INSURANCE", -- "A" / "F"
    ["INPUT_BLACKJACK_HIT"] = "@BLACKJACK.HIT", -- "X" / "A"
    ["INPUT_BLACKJACK_SPLIT"] = "@BLACKJACK.SPLIT", -- "RB" / "X"
    ["INPUT_BLACKJACK_DOUBLE_DOWN"] = "@BLACKJACK.DOUBLE_DOWN", -- "Y" / "D"
    ["INPUT_BLACKJACK_STAND"] = "@BLACKJACK.STAND", -- "A" / "S"
    ["INPUT_POKER_CHEAT"] = "@POKER.CHEAT", -- "Y" / "Y"
    ["INPUT_POKER_FOLD"] = "@POKER.FOLD", -- "X" / "F"
    ["INPUT_FIVE_FINGER_A_BUTTON"] = "@FIVE_FINGER.A_BUTTON", -- "A" / "1"
    ["INPUT_FIVE_FINGER_B_BUTTON"] = "@FIVE_FINGER.B_BUTTON", -- "B" / "2"
    ["INPUT_FIVE_FINGER_C_BUTTON"] = "@FIVE_FINGER.C_BUTTON", -- "Y" / "3"
    ["INPUT_FIVE_FINGER_D_BUTTON"] = "@FIVE_FINGER.D_BUTTON", -- "X" / "4"
    ["INPUT_HORSESHOES_LOOK_AROUND_X"] = "@HORSESHOES.LOOK_AROUND_X", -- "LSTICK X" / "ARROW KEYS LEFT/RIGHT" GET_ANALOGUE_ACTION Only
    ["INPUT_HORSESHOES_LOOK_AROUND_Y"] = "@HORSESHOES.LOOK_AROUND_Y", -- "LSTICK Y" / "ARROW KEYS UP/DOWN" GET_ANALOGUE_ACTION Only
    ["INPUT_HORSESHOES_ZOOM_AT_STAKE"] = "@HORSESHOES.ZOOM_AT_STAKE", -- "X" / "E"
    ["INPUT_HORSESHOES_SKIP_TO_PLAYER"] = "@HORSESHOES.SKIP_TO_PLAYER", -- "A" / "Q"
    ["INPUT_HORSESHOES_RELEASE"] = "@HORSESHOES.RELEASE", -- "RTRIGGER" / "SPACEBAR"
    ["INPUT_HORSESHOES_AIM"] = "@HORSESHOES.AIM", -- "LTRIGGER" / "LCTRL"
    ["INPUT_HORSESHOES_AIM_LEFT"] = "@HORSESHOES.AIM_LEFT", -- "LSTICK LEFT" / "A"
    ["INPUT_HORSESHOES_AIM_RIGHT"] = "@HORSESHOES.AIM_RIGHT", -- "LSTICK RIGHT" / "D"
    ["INPUT_HORSESHOES_SWITCH_SIDES"] = "@HORSESHOES.SWITCH_SIDES", -- "A" / "R"
    ["INPUT_HORSESHOES_SWING_FORWARD"] = "@HORSESHOES.SWING_FORWARD", -- "RSTICK UP" / "W"
    ["INPUT_HORSESHOES_SWING_BACKWARD"] = "@HORSESHOES.SWING_BACKWARD", -- "RSTICK DOWN" / "S"
    ["INPUT_LIARS_DICE_ANTE"] = "@LIARS_DICE.ANTE", -- "X" / "SPACEBAR"
    ["INPUT_LIARS_DICE_CHANGE_DICE_UP"] = "@LIARS_DICE.CHANGE_DICE_UP", -- "RSTICK UP" / "ARROW KEY UP"
    ["INPUT_LIARS_DICE_CHANGE_DICE_DOWN"] = "@LIARS_DICE.CHANGE_DICE_DOWN", -- "RSTICK DOWN" / "ARROW KEY DOWN"
    ["INPUT_LIARS_DICE_SPOT_ON"] = "@LIARS_DICE.SPOT_ON", -- "Y" / "D"
    ["INPUT_MINIGAME_INCREASE_BET"] = "@MINIGAME.INCREASE_BET", -- "DPAD UP" / "W"
    ["INPUT_MINIGAME_DECREASE_BET"] = "@MINIGAME.DECREASE_BET", -- "DPAD DOWN" / "S"
    ["INPUT_MINIGAME_SKIP_HELP"] = "@MINIGAME.SKIP_HELP", -- "A" / "Q"
    ["INPUT_MINIGAME_SHOW_HELP"] = "@MINIGAME.SHOW_HELP", -- "BACK" / "TAB"
    ["INPUT_MINIGAME_SKIP_TO_PLAYER"] = "@MINIGAME.SKIP_TO_PLAYER", -- "RB" / "LCTRL"
    ["INPUT_MINIGAME_LOOK_AROUND"] = "@MINIGAME.LOOK_AROUND", -- "BLANK" / "LALT"
    ["INPUT_MINIGAME_LOOK_AT_HAND"] = "@MINIGAME.LOOK_AT_HAND", -- "RTRIGGER" / "LSHIFT"
    ["INPUT_MINIGAME_LOOK_AT_DEALER"] = "@MINIGAME.LOOK_AT_DEALER", -- "LTRIGGER" / "E"
    ["INPUT_UI_UP_2"] = "@UI.UP_2", 
    ["INPUT_UI_DOWN_2"] = "@UI.DOWN_2", 
    ["INPUT_UI_LEFT_2"] = "@UI.LEFT_2", 
    ["INPUT_UI_RIGHT_2"] = "@UI.RIGHT_2", 
    ["INPUT_POKER_LOOK_AT_SCORE"] = "@POKER.LOOK_AT_SCORE", 
    ["INPUT_FIVE_FINGER_CHANGE_CAMERA"] = "@FIVE_FINGER.CHANGE_CAMERA", 
}
```